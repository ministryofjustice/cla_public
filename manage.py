...
def download_means_test():
    file_path = os.path.join(
        os.path.dirname(__file__), "cla_public", "apps", "checker", "tests", "data", "means_test.xlsx"
    )
    spreadsheet_id = "1idIleO4-mNTM0pW6-aOcMwXgK_0yjrpL7YkHHeuWL5c"
    response = requests.get("https://docs.google.com/spreadsheets/d/%s/export?format=xlsx" % spreadsheet_id)
