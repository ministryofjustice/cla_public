...
#               "your_benefits-none_of_above": [0],
    ...
    def _get_your_income_post_data(self):
        return {
            ...
            'your_income-self_employment_drawings_0': [0],
            'your_income-self_employment_drawings_1': ['per_month'],
            'your_income-benefits_0': [0],
            'your_income-benefits_1': ['per_month'],
            'your_income-tax_credits_0': [0],
            'your_income-tax_credits_1': ['per_month'],
            'your_income-child_benefits_0': [0],
            'your_income-child_benefits_1': ['per_month'],
            'your_income-maintenance_received_0': [0],
            'your_income-maintenance_received_1': ['per_month'],
            'your_income-pension_0': [0],
            'your_income-pension_1': ['per_month'],
            ...
            'partners_income-self_employment_drawings_0': [0],
            'partners_income-self_employment_drawings_1': ['per_month'],
            'partners_income-benefits_0': [0],
            'partners_income-benefits_1': ['per_month'],
            'partners_income-tax_credits_0': [0],
            'partners_income-tax_credits_1': ['per_month'],
            'partners_income-child_benefits_0': [0],
            'partners_income-child_benefits_1': ['per_month'],
            'partners_income-maintenance_received_0': [0],
            'partners_income-maintenance_received_1': ['per_month'],
            'partners_income-pension_0': [0],
            'partners_income-pension_1': ['per_month'],
